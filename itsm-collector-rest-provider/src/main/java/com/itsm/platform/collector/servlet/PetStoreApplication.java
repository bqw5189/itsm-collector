package com.itsm.platform.collector.servlet;
...
public class PetStoreApplication extends Application {
    ...
    public PetStoreApplication() {
        ...
        beanConfig.setFilterClass("com.itsm.platform.collector.util.ApiAuthorizationFilterImpl");
        beanConfig.setResourcePackage("com.itsm.platform.collector.facade");
